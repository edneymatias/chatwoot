...
ActiveRecord::Schema[7.2].define(version: 2126_09_03_100000) do
  ...
  create_table "ichatr_opportunities", force: :cascade do |t|
    ...
    t.index ["title", "campaign_name", "campaign_adset_name", "campaign_ad_name"], name: "index_ichatr_opportunities_on_title_and_campaign_trgm", opclass: :gin_trgm_ops, using: :gin
  end
  ...
  create_table "ichatr_opportunity_stage_changes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_ichatr_opportunity_stage_changes_on_account_id"
    t.index ["from_stage_id"], name: "index_ichatr_opportunity_stage_changes_on_from_stage_id"
    t.index ["opportunity_id", "changed_at"], name: "idx_on_opportunity_id_changed_at_712f015910"
    t.index ["opportunity_id"], name: "index_ichatr_opportunity_stage_changes_on_opportunity_id"
    t.index ["to_stage_id", "changed_at"], name: "idx_on_to_stage_id_changed_at_492a489de1"
    t.index ["to_stage_id"], name: "index_ichatr_opportunity_stage_changes_on_to_stage_id"
  end

  create_table "ichatr_pipeline_card_field_configs", force: :cascade do |t|
    t.bigint "account_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_ichatr_pipeline_card_field_configs_on_account_id"
    t.index ["custom_attribute_definition_id"], name: "idx_on_custom_attribute_definition_id_c261edd620"
  end

  create_table "ichatr_pipeline_closing_required_fields", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "custom_attribute_definition_id", null: false
    t.integer "outcome", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "custom_attribute_definition_id", "outcome"], name: "idx_ichatr_pipeline_closing_req_fields_on_acc_attr_outcome", unique: true
    t.index ["account_id"], name: "index_ichatr_pipeline_closing_required_fields_on_account_id"
    t.index ["custom_attribute_definition_id"], name: "idx_on_custom_attribute_definition_id_4768139358"
  end

  create_table "ichatr_pipeline_currency_settings", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.string "currency", default: "usd", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_ichatr_pipeline_currency_settings_on_account_id", unique: true
  end

  create_table "ichatr_pipeline_stage_required_fields", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "pipeline_stage_id", null: false
    t.bigint "custom_attribute_definition_id", null: false
    t.datetime "created_at", null: false
  ...
  create_table "ichatr_pipeline_stages", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.string "name", null: false
    t.integer "position", null: false
    t.datetime "created_at", null: false
  ...
  add_foreign_key "ichatr_opportunity_stage_changes", "ichatr_pipeline_stages", column: "to_stage_id"
  add_foreign_key "ichatr_pipeline_card_field_configs", "accounts"
  add_foreign_key "ichatr_pipeline_card_field_configs", "custom_attribute_definitions"
  add_foreign_key "ichatr_pipeline_closing_required_fields", "accounts"
  add_foreign_key "ichatr_pipeline_closing_required_fields", "custom_attribute_definitions"
  add_foreign_key "ichatr_pipeline_currency_settings", "accounts"
  add_foreign_key "ichatr_pipeline_stage_required_fields", "accounts"
